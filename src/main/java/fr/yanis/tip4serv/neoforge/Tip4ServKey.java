package fr.yanis.tip4serv.neoforge;
...
public class Tip4ServKey {
    ...
    public static void init(){
        File file = new File("config/tip4serv/tip4serv.key");
            ...
            try {
                ...
                if (API_KEY != null && !API_KEY.isEmpty()) {
                    ...
                    if (parts.length == 3) {
                        ...
                        future.completeExceptionally(new Exception("Please provide a valid API key in config/tip4serv/tip4serv.key"));
                    }
                } else {
                    future.completeExceptionally(new Exception("Please provide a valid API key in config/tip4serv/tip4serv.key"));
                }
    ...
    public static String getApiKey() {
        if (API_KEY == null || API_KEY.isEmpty())
            LOGGER.info("Please provide a valid API key in config/tip4serv/tip4serv.key");
        else {
            return API_KEY;
        }
        return "";
